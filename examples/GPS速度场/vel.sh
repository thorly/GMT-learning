...
R="96/107/20/30"
gmt figure ITRF下水平速度场 png
    gmt basemap -R$R -JM8c -Baf -BWSne
    gmt grdcut @earth_relief_30s.grd -R$R -Gcut.grd
    gmt grdimage cut.grd -Cdem2 -I+d
    gawk '{print $1,$2,$3,$4,0,0,0}' ITRF下水平速度场 > tmp3.txt
    # REM 绘制 GPS 速度矢量
    ...
    gmt velo tmp3.txt -Se0.03c/0.95/0 -A0.15c+e+p0.75p -Gblue -W0.2p,blue
    # 绘制垂直空白
